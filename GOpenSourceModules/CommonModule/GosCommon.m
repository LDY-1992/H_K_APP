...
- (BOOL)setApplicationInfo:(NSDictionary *)info {
    @try {
        if (nil == info) {
            [GizWifiSDK startWithAppID:APP_ID appSecret:APP_SECRET specialProductKeys:@[PRODUCT_KEY_K18,PRODUCT_KEY_K19,PRODUCT_KEY_MO] cloudServiceInfo:@{@"openAPIInfo": DEFAULT_API_DOMAIN,
            ...
            [GizWifiSDK startWithAppID:appid appSecret:APP_SECRET specialProductKeys:@[PRODUCT_KEY_K18,PRODUCT_KEY_K19,PRODUCT_KEY_MO] cloudServiceInfo:mInfo autoSetDeviceDomain:NO];
